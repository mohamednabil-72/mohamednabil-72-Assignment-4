        ...
        180
            ...
            do
            {
                ...
                switch (option)
                {
                    ...
                    case 7:
                        AnalyzeDurations(sessionDurations);
                        break;
                    ...
                    case 12:
                        DateTime customDate = ReadValidDate();
                        Console.WriteLine($"Valid date: {customDate}");
                        break;
